...
_asm\
	...
	lp9:
		...
		if (mono)
		{
		memcpy( 0xb0000124, &hour,6);
		memcpy( 0xb000012a, &min,6);
		memcpy( 0xb0000130, &sec,4);
		memcpy( 0xb0000136, &ampm,4);
		}
		else
		{
		memcpy( 0xb8000124, &hour,6);
		memcpy( 0xb800012a, &min,6);
		memcpy( 0xb8000130, &sec,4);
		memcpy( 0xb8000136, &ampm,4);
		}
	_asm\
	{
		push ax
